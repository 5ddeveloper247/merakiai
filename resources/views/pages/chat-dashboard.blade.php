...
@include('includes.header', [
    'customTitle' => 'Chat Dashboard',
    'customCSSPath' => asset('assets/bootstrap/css/chat_style.css'),
])
...
<body>
            ...
            <div class="vh-100 overflow-auto scroll-bar-left-side">
                <div class="sidebar-logo">
                    <div class="user-profile position-relative">
                        ...
                        <img role="button" class="img-fluid rounded-circle dropdown_list cursor-pointer"
                            src="{{ asset('assets/images/logo.jpeg') }}" width="30" alt="" />
                        <ul class="dropdown-menu position-absolute">
                            ...
                            <li><a class="dropdown-item close-on-click" data-bs-toggle="modal"
                                    href="#price_modal_toggle" role="button">Packages</a></li>
                ...
                <div class="search_chat my-1 mx-2">
                    <div class="form-group has-search">
                        ...
                        <input type="search" class="form-control search_input rounded-pill shadow-sm"
                            placeholder="Search">
                    </div>
                </div>
                <!-- Sidebar Navigation -->
        ...
        <main class="main collapsed">
            ...
            <div class="main-content main_meraki container-fluid mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <div class="search_chat_main my-1 mx-2 w-50 mx-auto">
                            <div class="form-group has-search">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="pt-3 pe-3 scrollable-content"
                                                ...
                                                <div class="d-flex flex-row justify-content-start gap-2">
                                                    <img class="chat_image"
                                                        src="{{ asset('assets/images/user.png') }}" alt="avatar 1">
                                                ...
                                                <div class="d-flex flex-row justify-content-end gap-2">
                                                    ...
                                                    <input class="form-check-input select_for_bookmark ms-1 "
                                                        style="display:none" type="checkbox">
                                                    <img class="chat_image"
                                                        src="{{ asset('assets/images/logo.jpeg') }}" alt="avatar 1">
                                                </div>
                                                <div class="d-flex flex-row justify-content-start gap-2">
                                                    <img class="chat_image"
                                                        src="{{ asset('assets/images/user.png') }}" alt="avatar 1">
                                            ...
                                            <div
                                                ...
                                                <img class="chat_image mx-2"
                                                    src="{{ asset('assets/images/user.png') }}" alt="avatar 3">
                                                <input type="text"
                                                ...
                                                <a class="ms-3 send_chat_btn text-light p-2 rounded-3"
                                                    href="#!"><i class="bi bi-send-fill"></i></a>
                                            </div>
                                            <div
                    ...
                    <div class="col-md-12">
                        <div class="text-center position-relative">
                            ...
                            <img class="rounded-circle profile_image " width="100" height="100"
                                id="profile_image" src="{{ asset('assets/images/logo.jpeg') }}" alt="" />
    ...
    <script src="assets/bootstrap/js/chat_script.js"></script>
</body>
