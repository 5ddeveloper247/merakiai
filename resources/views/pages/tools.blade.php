        ...
        <div class="container my-5" data-aos="fade-right">
            ...
            <div class="row mt-5">
                <div class="col-12 col-sm-12 col-md-12 col-xl-6">
                    <img class="img-fluid" src="{{ asset('assets/images/tools.jpg') }}" style="border-radius: 10px"
                        alt="">
                </div>
            ...
            <div class="card" style="border-radius: 20px;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <img class="img-fluid" src="{{ asset('assets/images/pdf.png') }}" alt="">
                        ...
                        <div class="col-md-3 my-auto">
                            <div class="price_card_body align-items-center gap-3">
                                ...
                                <button class="contact_us scrollto d-block" onclick="location.href='payment'">
                        ...
                        <div class="col-md-6">
                            <div class="price_card_features">
                                ...
                                <div class="feature_list">
                                    <i class="bi bi-check2 check_tool"></i>
                                    <div class="price_card_feature">Lorem ipsum dolor sit amet consectetur adipisicing
                                        elit. Vitae, dignissimos!</div>
                                </div>
                                <div class="feature_list">
                                    <i class="bi bi-check2 check_tool"></i>
                                    <div class="price_card_feature">Lorem ipsum dolor, sit amet consectetur adipisicing
                                        elit. Modi recusandae adipisci eius iure</div>
                                </div>
                                <div class="feature_list">
                                    <i class="bi bi-check2 check_tool"></i>
                                    <div class="price_card_feature">Lorem ipsum dolor sit amet consectetur adipisicing
                                        elit. Autem dicta provident aliquid.</div>
                                </div>
                                <div class="feature_list">
                                    <i class="bi bi-check2 check_tool"></i>
                                    <div class="price_card_feature">Lorem ipsum dolor sit amet consectetur adipisicing
