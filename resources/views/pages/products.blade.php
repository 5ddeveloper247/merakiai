...
<body>
        ...
        <div class="container my-5" data-aos="fade-right">
            ...
            <div class="row mt-5">
                <div class="col-12 col-sm-12 col-md-12 col-xl-6">
                    <img class="img-fluid" src="{{ asset('assets/images/product-ai.jpg') }}" style="border-radius: 10px"
                        alt="">
                </div>
    ...
    <!-- Features section -->
    <section>
        <div class="container container-sm container-md container-lg container-xl container-xxl" id="features">
